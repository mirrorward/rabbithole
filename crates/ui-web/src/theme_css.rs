...
@media (max-width:720px){.rh-adm-acct-line{grid-template-columns:minmax(0,1fr) auto 1rem;row-gap:.1rem}.rh-adm-acct-line .rh-adm-acct-class{display:none}.rh-adm-acct-line .rh-adm-acct-state{grid-column:1;grid-row:2;font-size:var(--rh-font-xs)}.rh-adm-class-line .rh-adm-acct-role{display:none}.rh-adm-invite{grid-template-columns:minmax(0,1fr) auto}.rh-adm-invite-by{display:none}.rh-adm-invite-state{grid-column:1;font-size:var(--rh-font-xs)}.rh-adm-invite-actions{grid-column:2;grid-row:1/3}.rh-adm-peer{grid-template-columns:minmax(0,1fr) auto}.rh-adm-peer-state{grid-column:1;font-size:var(--rh-font-xs)}.rh-adm-peer-actions{grid-column:2;grid-row:1/3}.rh-adm-origin{grid-template-columns:minmax(0,1fr) auto}.rh-adm-origin-trust{grid-column:1;text-align:left;font-size:var(--rh-font-xs)}.rh-adm-filter{width:100%}.rh-adm-group-tools{width:100%}.rh-adm-inline{flex-wrap:wrap}}\
