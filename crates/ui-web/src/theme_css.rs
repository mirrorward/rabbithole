...
.rh-subnav-warren{display:none;border:0;background:transparent;font-family:inherit;cursor:pointer}\
...
.rh-subnav-scope{display:block;padding:.15rem .55rem .5rem;font-size:var(--rh-font-sm);font-weight:700;letter-spacing:-.01em;color:var(--rh-text);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}\
...
.rh-server-name{font-weight:600;font-size:var(--rh-font-size);color:var(--rh-text)}\
...
.rh-panel-title{display:flex;align-items:baseline;gap:.5rem;font-size:var(--rh-font-lg);font-weight:700;letter-spacing:-.01em;color:var(--rh-text);margin:0 0 var(--rh-space-3)}\
...
.rh-bar-fill{height:100%;border-radius:var(--rh-radius-full);background:linear-gradient(90deg,color-mix(in srgb,var(--rh-accent) 70%,var(--rh-surface)),var(--rh-accent));width:100%;transform-origin:left;transition:transform .3s ease}\
...
@media (max-width:720px){.rh-header{display:grid;grid-template-columns:auto minmax(0,1fr) auto auto;grid-template-areas:\"dot title presence theme\" \"live live live live\" \"nav nav nav nav\";align-items:center;padding:var(--rh-space-2) var(--rh-space-3);min-height:2.9rem;gap:var(--rh-space-2)}.rh-header .rh-leave{display:none}.rh-rail{display:none}.rh-sidenav-slot.warren-scope{display:contents}.rh-subnav-scope{display:none}.rh-subnav-warren{display:flex}.rh-header .rh-title{grid-area:title;font-size:var(--rh-font-size);min-width:0;overflow:hidden}.rh-dot{grid-area:dot}.rh-presence{grid-area:presence;justify-self:end;padding:.25rem 1.2rem .25rem .4rem;font-size:var(--rh-font-xs)}.rh-live-slot{grid-area:live;min-width:0;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}\
.rh-live-slot .rh-radio-now{display:block;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.rh-nav{grid-area:nav;min-width:0;overflow-x:auto;padding-bottom:.15rem}.rh-subnav{position:fixed;left:0;right:0;bottom:0;z-index:30;width:auto;flex-direction:row;gap:0;padding:.3rem var(--rh-space-2) calc(.3rem + env(safe-area-inset-bottom));overflow-x:auto;overflow-y:hidden;border-right:0;border-top:1px solid color-mix(in srgb,var(--rh-text) 12%,transparent);background:color-mix(in srgb,var(--rh-surface) 92%,transparent);backdrop-filter:saturate(1.4) blur(14px);-webkit-backdrop-filter:saturate(1.4) blur(14px)}.rh-subnav-link{flex:1 1 0;min-width:0;flex-direction:column;gap:.1rem;padding:.3rem .1rem;font-size:.62rem;justify-content:center}.rh-subnav-label{flex:none;max-width:100%;overflow:hidden;text-overflow:ellipsis}.rh-subnav-rule{display:none}.rh-subnav .rh-pip{position:absolute;top:.15rem;right:.5rem}.rh-subnav-link{position:relative}.rh-shell-main{padding-bottom:3.6rem}.rh-theme-menu{grid-area:theme;justify-self:end}.rh-theme-menu button{padding:.25rem .4rem;font-size:var(--rh-font-xs)}.rh-theme-menu .rh-icon-btn{width:1.75rem;padding:0}.rh-status,.rh-kbd-jump,.rh-spacer{display:none}.rh-header .rh-kbd-jump{display:none}.rh-conn{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;border:0}.rh-toasts{top:3.6rem}.rh-body{flex-direction:column}.rh-who,.rh-threads,.rh-members,.rh-files,.rh-stations{max-width:none;width:auto;border-right:0;border-left:0;border-bottom:1px solid color-mix(in srgb,var(--rh-text) 8%,transparent)}.rh-who{max-height:35vh}.rh-chat{min-height:0}.rh-filetable-head,.rh-filetable .rh-file-link{grid-template-columns:minmax(0,1fr) 5rem}.rh-fcol-kind,.rh-fcol-who,.rh-fcol-when{display:none}.rh-scroll{padding:var(--rh-space-3)}.rh-compose{padding:var(--rh-space-2) var(--rh-space-3)}.rh-compose .rh-input{min-width:0}.rh-compose .rh-btn{padding-left:var(--rh-space-4);padding-right:var(--rh-space-4)}.rh-present{order:-1;display:flex;align-items:center;gap:var(--rh-space-2);padding:.4rem var(--rh-space-3);max-height:none}.rh-present h2{margin:0;flex:none}.rh-present ul{flex-direction:row;flex:1;min-width:0;overflow-x:auto;gap:.4rem;padding-bottom:.15rem}.rh-present li{flex:none;white-space:nowrap}.rh-reader{min-height:14rem}.rh-login{margin:var(--rh-space-6) var(--rh-space-4)}}\
