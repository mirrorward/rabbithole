...
use crate::board::{
    BoardCreate, BoardCreated, BoardDelete, BoardList, BoardListRequest, BoardUpdate, MarkRead,
    PostCreate, PostDelete, PostEdit, PostPosted, PostReply, ThreadList, ThreadListRequest,
    ThreadPosts, ThreadRequest,
};
use crate::chat::{
...
use crate::radio::{RadioNowPlaying, RadioOff, RadioStations, RadioStationsRequest};
use crate::session::{
    AgreementAccept, AuthGuest, AuthOk, AuthPassword, AuthResume, Ping, Pong, ServerNotice, Welcome,
};
use crate::swarm::{
    AdvertWithdraw, AdvertiseAck, AdvertiseFiles, AdvertisePartial, FindAllSources, FindSources,
...
wire_registry! {
    ...
    SourceTicketRequest, SourceTicket, AdvertisePartial, FindAllSources,
